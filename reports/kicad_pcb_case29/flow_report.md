# KiCad PCB 布局布线报告 — [已验证] PN532RFID/NFC调试器

**日期**: 2026-08-12
**Case**: kicad_pcb_case29
...
| 项目 | 内容 |
|------|------|
| 设计目录 | `/home/lxq/AiEDA/iPCL-PCB/designs/23_[已验证] PN532RFID_NFC调试器` |
| 源归档 | `[已验证] PN532RFID_NFC调试器.epro2` |
| PCB 文档 | `PCB1.epcb` |
| PCB UUID | `f6002abbfdac47ffa915ca270ba60cfb` |
| 板名 | `Board1` |
...
- `[已验证] PN532RFID/NFC调试器.kicad_pcb`：KiCad PCB 文件
