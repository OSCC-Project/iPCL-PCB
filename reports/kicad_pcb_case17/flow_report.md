# KiCad PCB 布局布线报告 — 心电监护（含12导联功能）

**日期**: 2026-08-12
**Case**: kicad_pcb_case17
...
| 项目 | 内容 |
|------|------|
| 设计目录 | `/home/lxq/AiEDA/iPCL-PCB/designs/11_心电监护（含12导联功能）` |
| 源归档 | `心电监护（含12导联功能）.epro2` |
| PCB 文档 | `PCB1.epcb` |
| PCB UUID | `996b7a455ec1426db1a469fd6da41ff3` |
| 板名 | `Board1` |
...
- `心电监护（含12导联功能）.kicad_pcb`：KiCad PCB 文件
