# KiCad PCB 布局布线报告 — 四轮独立转向小车

**日期**: 2026-08-12
**Case**: kicad_pcb_case20
...
| 项目 | 内容 |
|------|------|
| 设计目录 | `/home/lxq/AiEDA/iPCL-PCB/designs/14_四轮独立转向小车` |
| 源归档 | `四轮独立转向小车.epro2` |
| PCB 文档 | `PCB2.epcb` |
| PCB UUID | `6a9417d62b754d6e819781993dc755b7` |
| 板名 | `Board3` |
...
- `四轮独立转向小车.kicad_pcb`：KiCad PCB 文件
