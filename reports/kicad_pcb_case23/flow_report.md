# KiCad PCB 布局布线报告 — 基于STM32G4的FOC电机驱动学习板

**日期**: 2026-08-12
**Case**: kicad_pcb_case23
...
| 项目 | 内容 |
|------|------|
| 设计目录 | `/home/lxq/AiEDA/iPCL-PCB/designs/18_基于STM32G4的FOC电机驱动学习板` |
| 源归档 | `基于STM32G4的FOC电机驱动学习板.epro2` |
| PCB 文档 | `axdr_v1.3.epcb` |
| PCB UUID | `0b65e980a4b1438e8b494e0d3e5e4396` |
| 板名 | `foc_driver` |
...
- `基于STM32G4的FOC电机驱动学习板.kicad_pcb`：KiCad PCB 文件
