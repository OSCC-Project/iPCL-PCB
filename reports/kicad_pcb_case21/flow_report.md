# KiCad PCB 布局布线报告 — 蓝桥杯单片机主板IAP15F2K61S2(一键下载版)

**日期**: 2026-08-12
**Case**: kicad_pcb_case21
...
| 项目 | 内容 |
|------|------|
| 设计目录 | `/home/lxq/AiEDA/iPCL-PCB/designs/15_蓝桥杯单片机主板IAP15F2K61S2(一键下载版)` |
| 源归档 | `蓝桥杯单片机主板IAP15F2K61S2(一键下载版).epro2` |
| PCB 文档 | `PCB蓝桥杯单片机开发板v2.epcb` |
| PCB UUID | `9bb7e9c4d11141c69c37d7f296efa099` |
| 板名 | `V2.0` |
...
- `蓝桥杯单片机主板IAP15F2K61S2(一键下载版).kicad_pcb`：KiCad PCB 文件
